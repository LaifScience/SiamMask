...
parser.add_argument('--base_path', default='../../data/Catalin_GUN_bright_green_shirt', help='datasets')
...
if __name__ == '__main__':
    ...
    with open('../../data/Catalin_GUN_bright_green_shirt.json', 'w') as outfile:  
